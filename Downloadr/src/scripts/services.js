...
(function () {
    ...
    app.factory('settings', ['$rootScope', '$timeout', 'storage',
    ...
    app.factory('downloadManager', ['$rootScope', 'settings', function ($rootScope, settings) {
    ...
    app.factory('fileManager', function () {
    ...
    app.factory('storage', ['runtime', function (runtime) {
...
var Base64 = {
	...
	app.service('flickr', ['$rootScope', '$http', 'HOST', function ($rootScope, $http, HOST) {
