'use strict';
// @ngInject
function DownloadController($scope, $rootScope, notify, downloadManager) {
    //// This is the continue method that is executed whenever a page is completely downloaded.
    //$scope.continue = null;
    //$scope.queue = [];
    //console.log('SETTING $SCOPE.ITEMS FROM selectionManager.ITEMS!, ', selectionManager.items);
    ...
    $scope.cancel = function () {
        ...
        $scope.title = 'Download cancelled';
    ...
    $scope.$on('$viewContentLoaded', function () {
        ...
        //downloadManager.progress = updateStatus;

        $scope.progress = downloadManager.start().then(downloadCompleted, handleError, updateStatus);
