'use strict';
// @ngInject
function DownloadController($scope, $rootScope, notify, downloadManager, logger) {
    ...
    function updateStatus(status) {
        ...
        $scope.count = status.count;
        $scope.current = status.current;
        $scope.percentage = status.percentage;
        $scope.skipped = status.skipped;
    };

    function downloadCompleted() {
        log.info('Download completed.', status);
